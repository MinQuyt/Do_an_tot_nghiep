...
-  Mở màn hình CommandLine với quyền admin để tạo các môi trường ảo
    + conda create -n quy_face4 -c conda-forge onnxruntime python=3.9 //Tạo môi trường ảo, python phiên bản 3.9, và cài onnxruntime để có thể sử dụng GPU để huấn luyện modal
