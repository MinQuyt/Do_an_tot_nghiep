...
# Hàm sinh frame từ IP camera
def gen_frames():
    ip_camera_url = "rtsp://admin:Minhquy1@192.168.1.11:80/cam/realmonitor?channel=1&subtype=0"
    ...
    while True:
        ...
        if not success:
            print("⚠️ Không thể đọc frame từ IP camera.")
            break
...
def upload_image():
    ...
    if file:
        ...
        for face in faces:
            name = "new_person"  # Placeholder cho người mới
