...
def send_telegram_message(message, image_path=None):
    ...
    if image_path and os.path.exists(image_path):
        ...
        response = requests.post(photo_url, data={"chat_id": TELEGRAM_CHAT_ID, "caption": message}, files=files)
    else:
    ...
    while True:
        ...
        for face in faces:
            ...
            if name != "Unknown":
                ...
                send_telegram_message("⚠️ Phát hiện người lạ không xác định!", image_path=image_path)       
